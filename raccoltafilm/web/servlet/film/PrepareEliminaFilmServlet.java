...
@WebServlet("/PrepareEliminaFilmServlet")
public class PrepareEliminaFilmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public PrepareEliminaFilmServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.setAttribute("elimina_film_attr", filmDaInviare);
		} catch (Exception e) {
			e.printStackTrace();
